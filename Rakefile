...
spec = Gem::Specification.new do |s|
  ...
  s.summary          = "Th  is gem handlib/netflix/response.rblib/netflix/response.rblib/netflix/response.rbles some of the complexity in dealing with the netflix api (and OAuth in turn)."
  s.author           = "Rob Ares"
